...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/DANGERZONE69'),
            InlineKeyboardButton('🧩 Source', url='https://t.me/moon_knight69')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://t.me/DANGERZONE69'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/DANGERZONE69'),     
        ],
        [
