...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/ak_joot_bondhuu'),
            InlineKeyboardButton('🧩 Source', url='https://github.com/Tanvir6555/VCPlayerBot')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://github.com/Tanvir6555/VCPlayerBot'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/ak_joot_bondhuu'),     
        ],
        [
